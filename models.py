...
class NumGNN(nn.Module):
    ...
    def __init__(self, node_dim, iteration_steps=1):
        ...
        self.gat = GAT(1, [1], [node_dim, node_dim])
    ...
    def forward(self, d_node, greater_graph, smaller_graph):
        ...
        for step in range(self.iteration_steps):
            ...
            t1 = (dd_node_info_left, dd_graph_left)
            dd_node_info_left, _ = self.gat(t1)
            ...
            t2 = (dd_node_info_right, dd_graph_right)
            dd_node_info_right, _ = self.gat(t2)
